...
public class SwaggerConfig{
    ...
    public Docket produceApi(){
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.dscjss.lineup"))
                .build();
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Line up APIs")
                .description("This page lists all the rest apis for Line Up.")
...
/*    @Value("${app.client.id}")
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Line Up API").description("")
                .version("1.0.0").build();
    }*/
}